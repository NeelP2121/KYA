                ...
                <div className="flex-grow flex flex-col justify-between px-5 pb-5">
                  ...
                  <div className="flex justify-between items-center mt-auto border-t border-gray-100 pt-4">
                    ...
                    <button 
                      ...
                      className="bg-black text-white px-5 py-2.5 rounded-full text-sm font-medium hover:bg-gray-800 transition-colors shadow-md hover:shadow-lg focus:ring-2 focus:ring-offset-2 focus:ring-black"
                    >
                      Add to Cart
                    </button>
                  </div>
